    ...
    <div className="relative" ref={searchRef}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-40 sm:w-72 pl-4 pr-11 py-1.5 bg-gray-50 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all"
        />
        {searchQuery && (
          <button
            onClick={() => {
